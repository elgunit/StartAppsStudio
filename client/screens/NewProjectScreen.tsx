...
const PLANS: PlanConfig[] = [
  {
    ...
    roles: [
      ...
      { hat: "developer", label: "Developer", title: "CTO", icon: "code", credits: 150 },
    ],
  },
  {
    tier: "prototype",
    ...
    highlight: true,
    roles: [
      { hat: "designer", label: "Designer", title: "CDO", icon: "pen-tool", credits: 600 },
      { hat: "developer", label: "Developer", title: "CTO", icon: "code", credits: 700 },
      { hat: "strategist", label: "Strategist", title: "CSO", icon: "target", credits: 250 },
      { hat: "manager", label: "Manager", title: "COO", icon: "clipboard", credits: 250 },
    ],
  },
  {
    tier: "production",
    name: "MVP",
    tagline: "Shippable iOS, Android or web · 3-8 weeks",
    totalCredits: 7000,
    price: "$4.5k - $9.5k",
    icon: "box",
    roles: [
      ...
      { hat: "strategist", label: "Strategist", title: "CSO", icon: "target", credits: 1000 },
      { hat: "manager", label: "Manager", title: "COO", icon: "clipboard", credits: 1000 },
      { hat: "analyst", label: "Analyst", title: "CAO", icon: "bar-chart-2", credits: 1000 },
    ],
  },
  {
    tier: "custom",
    name: "Custom",
    tagline: "Multi-platform & scale · 1-6 months",
    totalCredits: 15000,
    price: "$15k+",
    icon: "star",
    roles: [
      { hat: "designer", label: "Designer", title: "CDO", icon: "pen-tool", credits: 3000 },
      { hat: "developer", label: "Developer", title: "CTO", icon: "code", credits: 5000 },
      { hat: "strategist", label: "Strategist", title: "CSO", icon: "target", credits: 2500 },
      { hat: "manager", label: "Manager", title: "COO", icon: "clipboard", credits: 2000 },
      { hat: "analyst", label: "Analyst", title: "CAO", icon: "bar-chart-2", credits: 2500 },
    ],
  },
];
