...
const offers = [
  { label: "Launch Site", amount: "$1,800" },
  { label: "Prototype", amount: "$5,000" },
  { label: "MVP", amount: "$9,000–$30,000" },
  { label: "Custom", amount: "$45,000+" },
] as const;

const localizedOffers = [
  { label: "Saytı başlat", amount: "$1,800" },
  { label: "Prototip", amount: "$5,000" },
  { label: "MVP", amount: "$9,000–$30,000" },
  { label: "Verilmiş müddət", amount: "$45,000+" },
] as const;
